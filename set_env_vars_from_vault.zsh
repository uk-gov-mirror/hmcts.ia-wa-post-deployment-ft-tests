...
main() {
  ...
  echo TEST_E2E_URL_WEB="https://manage-case.$1.platform.hmcts.net"
  echo RETRIES=0
  echo TEST_E2E_URL_GATEWAY="https://gateway-ccd.$1.platform.hmcts.net"
  echo TEST_E2E_NUM_BROWSERS=1
  echo TEST_E2E_WAIT_FOR_ANGULAR=false
  echo TEST_E2E_FAIL_FAST=false
  echo TEST_E2E_HEADLESS=false
}
